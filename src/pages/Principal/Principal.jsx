...
function Principal() {
    ...
    const redirigir = (gameid) => {
      ...
      axiosInstance.get(`${import.meta.env.VITE_BACKEND_URL}/game/${gameid}`)
          .then( (response) => {
              let seat = 0;
              ...
              axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/table/${gameid}/${seat}`)
                  .then( (response) => {
                      console.log(response.data);
  ...
  useEffect(() => {
      axiosInstance.get(`${import.meta.env.VITE_BACKEND_URL}/game`)
          .then( (response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/table/creategame`, {
        min_bet: minBet,
        max_bet: maxBet
    })
        .then( (response) => {
